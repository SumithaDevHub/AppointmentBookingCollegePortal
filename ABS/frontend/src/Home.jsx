    ...
    <div className="relative h-screen w-full bg-cover bg-center bg-no-repeat text-white bg-gray-800">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-y-8 text-center">
        ...
        <div className="flex flex-col md:flex-row gap-6 text-xl font-semibold">
          <a href="#" className="hover:text-blue-300">Login as Student</a>
          <a href="#" className="hover:text-blue-300">Login as Admin</a>
          <a href="#" className="hover:text-blue-300">Login as Faculty</a>
        </div>

        {/* Register Links */}
        <div className="flex flex-col md:flex-row gap-6 text-sm font-semibold">
          <a href="#" className="underline hover:text-blue-300">REGISTER AS ADMIN</a>
          <a href="#" className="underline hover:text-blue-300">REGISTER AS STUDENT</a>
          <a href="#" className="underline hover:text-blue-300">REGISTER AS FACULTY</a>
        </div>
      </div>
    </div>
  );
